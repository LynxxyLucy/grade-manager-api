...
INSERT INTO "new_Grade" ("createdAt", "grade", "id", "subjectId", "subjectName", "type", "updatedAt") SELECT "createdAt", "grade", "id", "subjectId", "subjectName", "type", "updatedAt" FROM "Grade";
DROP TABLE "Grade";
